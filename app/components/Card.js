...
export const Card = forwardRef(({ id, frontSrc, frontAlt, backText }, ref) => {
  ...
  const backStyle = {
    ...
    border: '2px solid #e5e7eb', // The stroke border
    borderRadius: '12px',
    height: '100%',
  ...
  return (
    <div className="card" id={id} ref={ref}>
      <div className="card-wrapper">
        ...
        <div className="flip-card-front" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <Image 
  ...
  <div>
    <header style={{ marginBottom: '1rem' }}>
      ...
      <p style={{ margin: 0, fontSize: '0.8rem', color: '#6b7280' }}>Full-time • Remote</p>
    </header>

    <div className="skills-section">
      <p style={{ fontSize: '0.7rem', fontWeight: 'bold', color: '#374151', textTransform: 'uppercase', marginBottom: '8px' }}>
        Core Competency
      </p>
